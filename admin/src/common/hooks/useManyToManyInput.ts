...
export const useManyToManyInput = ({joinResource, resourceField, referenceField}: UseManyToManyInputOptions) => {
    const dataProvider = useDataProvider()

    const mutateJoinResource = async ({id, newReferences}: MutateJoinResourceOptions) => {
