import {Create, ReferenceInput, SelectInput, SimpleForm, TextInput, useRedirect} from 'react-admin';
        ...
        <Create title="Нове замовлення" transform={transform} mutationOptions={{onSuccess}}>
            <SimpleForm>
                ...
                <ReferenceInput source="status" reference="order_status">
                    <SelectInput optionText="label" label="Статус замовлення" defaultValue={Order_Status_Enum.New} disabled/>
                </ReferenceInput>
                <ManyToManyInput
                    label="Меню"
                    reference="menu"
